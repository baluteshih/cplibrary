...
data:
  ...
  bundledCode: "#line 2 \"Geometry/half_plane_intersection.hpp\"\n\n#line 2 \"Geometry/base.hpp\"\
    ...
    \  using type = Ln<T, eps, MulT>;\n};\n#line 5 \"Geometry/half_plane_intersection.hpp\"\
    ...
    \ ? Line::eps_val : get_default_eps<MulT>()>\nbool line_contain(const Line &l0,\
    \ const Line &l1, const Line &l2, bool strict = true) {\n    auto area_pair =\
    \ [&](const Line &a, const Line &b) {\n        return std::make_pair(cross(a[1]\
    \ - a[0], b[0] - a[0]), cross(a[1] - a[0], b[1] - a[0]));\n    };\n    auto [a02X,\
    \ a02Y] = area_pair(l0, l2);\n    auto [a12X, a12Y] = area_pair(l1, l2);\n   \
...
layout: document
redirect_from:
- /library/Geometry/half_plane_intersection.hpp
- /library/Geometry/half_plane_intersection.hpp.html
