...
data:
  ...
  bundledCode: "#line 2 \"Flow/min_cost_circulation.hpp\"\n\n#line 2 \"Graph/base.hpp\"\
    \n\ntemplate<typename W>\nstruct edge_data {\n    int from, to;\n    W weight;\n\
    \    edge_data() = default;\n    edge_data(int u, int v, const W &w) : from(u),\
    \ to(v), weight(w) {}\n};\ntemplate<>\nstruct edge_data<void> { \n    int from,\
    \ to; \n    edge_data() = default;\n    edge_data(int u, int v) : from(u), to(v)\
    \ {}\n};\n\ntemplate<bool directed = true, typename Edge = void, typename Vertex\
    ...
    \ constexpr bool hasEdgeWeightReverse = requires(Edge v) { v.reverse(); };\n \
