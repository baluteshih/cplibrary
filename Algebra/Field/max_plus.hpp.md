...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"Algebra/Field/max_plus.hpp\"\n\ntemplate<typename T>\nstruct\
    \ max_plus {\n    T a;\n    max_plus(T _a = -std::numeric_limits<T>::max() / 2):\
    \ a(std::max(_a, -std::numeric_limits<T>::max() / 2)) {}\n    max_plus operator+(const\
  ...
  path: Algebra/Field/max_plus.hpp
  requiredBy: []
  timestamp: '2026-06-30 17:03:55+08:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: Algebra/Field/max_plus.hpp
layout: document
redirect_from:
- /library/Algebra/Field/max_plus.hpp
- /library/Algebra/Field/max_plus.hpp.html
title: Algebra/Field/max_plus.hpp
---
