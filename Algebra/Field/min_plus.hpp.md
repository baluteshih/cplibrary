...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"Algebra/Field/min_plus.hpp\"\n\ntemplate<typename T>\nstruct\
    \ min_plus {\n    T a;\n    min_plus(T _a = std::numeric_limits<T>::max() / 2):\
    \ a(std::min(_a, std::numeric_limits<T>::max() / 2)) {}\n    min_plus operator+(const\
  ...
  path: Algebra/Field/min_plus.hpp
  requiredBy: []
  timestamp: '2026-06-30 17:03:55+08:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: Algebra/Field/min_plus.hpp
layout: document
redirect_from:
- /library/Algebra/Field/min_plus.hpp
- /library/Algebra/Field/min_plus.hpp.html
title: Algebra/Field/min_plus.hpp
---
