...
std::vector<T> or_convolution(std::vector<T> a, std::vector<T> b) {
    ...
    if (a == b)
        bitwise_transform::transform<bitwise_transform::subset, bitwise_transform::zeta>(a), b = a; 
    else {
    ...
    bitwise_transform::transform<bitwise_transform::subset, bitwise_transform::mobius>(a);
    return a;
}
