...
data:
  ...
  attributes:
    ...
    links:
    - https://loj.ac/p/101
  bundledCode: "#line 1 \"test/7_loj/maxflow.test.cpp\"\n#define PROBLEM \"https://loj.ac/p/101\"\
    \n#define IGNORE\n#line 2 \"assumption.hpp\"\n\n#include <cassert>\n#include <bits/stdc++.h>\n\
    #line 4 \"test/7_loj/maxflow.test.cpp\"\n\n#line 2 \"Flow/Dinic.hpp\"\n\n#line\
    ...
    \ res;\n    }\n};\n#line 6 \"test/7_loj/maxflow.test.cpp\"\n\nint main() {\n \
    \   std::ios::sync_with_stdio(0), std::cin.tie(0);\n    int n, m, s, t;\n    std::cin\
    \ >> n >> m >> s >> t;\n    --s, --t;\n    Dinic<long long> flow(n);\n    while\
    \ (m--) {\n        int u, v, c;\n        std::cin >> u >> v >> c;\n        --u,\
    \ --v;\n        flow.add_edge(u, v, c);\n    }\n    std::cout << flow.maxflow(s,\
    \ t) << \"\\n\";\n}\n"
  code: "#define PROBLEM \"https://loj.ac/p/101\"\n#define IGNORE\n#include \"assumption.hpp\"\
...
layout: document
redirect_from:
- /verify/test/7_loj/maxflow.test.cpp
- /verify/test/7_loj/maxflow.test.cpp.html
