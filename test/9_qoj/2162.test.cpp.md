...
data:
  ...
  bundledCode: "#line 1 \"test/9_qoj/2162.test.cpp\"\n#define PROBLEM \"https://qoj.ac/contest/782/problem/2162\"\
    ...
    \ */\n    return res;\n} // convex cut: (r, l]\n#line 8 \"test/9_qoj/2162.test.cpp\"\
    ...
    \ <= 2) return (double)0;\n        polygon poly;\n        for (int i = 0; i <\
    \ int(ln.size()); ++i)\n            poly.push_back(lineIntersection(ln[i], ln[(i\
    \ + 1) % int(ln.size())]));\n        return poly.area();\n    };\n\n    auto res\
    \ = half_plane_intersection<Line, __int128>(lines);\n    double ans = area(res);\n\
    \    auto convex = convexHull(dots); \n    for (int i = 0; i < int(convex.size());\
  ...
  verifiedWith: []
documentation_of: test/9_qoj/2162.test.cpp
layout: document
redirect_from:
- /verify/test/9_qoj/2162.test.cpp
- /verify/test/9_qoj/2162.test.cpp.html
