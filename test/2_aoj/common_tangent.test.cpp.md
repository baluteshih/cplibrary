...
data:
  ...
  bundledCode: "#line 1 \"test/2_aoj/common_tangent.test.cpp\"\n#define PROBLEM \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_G\"\n#define ERROR\
    ...
    }\n#line 4 \"test/2_aoj/common_tangent.test.cpp\"\n\n#line 2 \"Geometry/circle.hpp\"\
    ...
    \ += s - t;\n            std::swap(a, b);\n        }\n        return res;\n  \
    \  }\n};\n#line 6 \"test/2_aoj/common_tangent.test.cpp\"\n\nusing cir = Circle<int>;\n\
    \nint main() {\n    ios::sync_with_stdio(0), cin.tie(0);\n    cir a, b;\n    cin\
    \ >> a.o >> a.r >> b.o >> b.r;\n    vector<Pt<double>> ans;\n    for (auto ln\
    \ : externalTangent(a, b))\n        ans.push_back(ln[0]);\n    for (auto ln :\
    \ internalTangent(a, b))\n        ans.push_back(ln[0]);\n    if (typeOfCircles(a,\
    \ b) == 3)\n        ans.push_back(Pt<double>(a.o * b.r + b.o * a.r) / (double)(a.r\
    \ + b.r));\n    if (typeOfCircles(a, b) == 1) {\n        ans.push_back(Pt<double>(a.o\
    \ * b.r - b.o * a.r) / (double)(b.r - a.r));\n    }\n    sort(ans.begin(), ans.end());\n\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_G\"\
    ...
    \ (typeOfCircles(a, b) == 3)\n        ans.push_back(Pt<double>(a.o * b.r + b.o\
    \ * a.r) / (double)(a.r + b.r));\n    if (typeOfCircles(a, b) == 1) {\n      \
  ...
  verifiedWith: []
documentation_of: test/2_aoj/common_tangent.test.cpp
layout: document
redirect_from:
- /verify/test/2_aoj/common_tangent.test.cpp
- /verify/test/2_aoj/common_tangent.test.cpp.html
