...
data:
  ...
  bundledCode: "#line 1 \"test/2_aoj/type_of_circle.test.cpp\"\n#define PROBLEM \"\
    ...
    \ += s - t;\n            std::swap(a, b);\n        }\n        return res;\n  \
    \  }\n};\n#line 5 \"test/2_aoj/type_of_circle.test.cpp\"\n\nusing cir = Circle<int>;\n\
    \nint main() {\n    std::ios::sync_with_stdio(0), std::cin.tie(0);\n    cir a,\
    \ b;\n    std::cin >> a.o >> a.r >> b.o >> b.r;\n    std::cout << typeOfCircles(a,\
    \ b) << \"\\n\";\n}\n"
...
layout: document
redirect_from:
- /verify/test/2_aoj/type_of_circle.test.cpp
- /verify/test/2_aoj/type_of_circle.test.cpp.html
