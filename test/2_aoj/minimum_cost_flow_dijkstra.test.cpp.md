...
data:
  ...
  bundledCode: "#line 1 \"test/2_aoj/minimum_cost_flow_dijkstra.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_6_B\"\
    ...
    }\n#line 3 \"test/2_aoj/minimum_cost_flow_dijkstra.test.cpp\"\n\n#line 2 \"Flow/min_cost_max_flow.hpp\"\
    ...
    \ -cost, T(0)));\n    }\n};\n#line 5 \"test/2_aoj/minimum_cost_flow_dijkstra.test.cpp\"\
    \n\nint main() {\n    ios::sync_with_stdio(0), cin.tie(0);\n    int n, m, f;\n\
    \    cin >> n >> m >> f;\n    min_cost_max_flow<int> mcmf(n + 1);\n    while (m--)\
    \ {\n        int u, v, c, d;\n        cin >> u >> v >> c >> d;\n        mcmf.add_edge(u,\
    \ v, c, d);\n    }\n    mcmf.add_edge(n, 0, f, 0);\n    auto [flow, cost] = mcmf.solve<false>(n,\
    \ n - 1);\n    if (flow != f) cout << \"-1\\n\";\n    else cout << cost << \"\\\
    n\";\n}\n"
...
layout: document
redirect_from:
- /verify/test/2_aoj/minimum_cost_flow_dijkstra.test.cpp
- /verify/test/2_aoj/minimum_cost_flow_dijkstra.test.cpp.html
