...
data:
  ...
  bundledCode: "#line 1 \"test/2_aoj/area_of_intersection_between_two_circles.test.cpp\"\
    \n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_I\"\
    \n#define ERROR 0.000001\n#line 2 \"assumption.hpp\"\n\n#include <cassert>\n#include\
    \ <bits/stdc++.h>\n#line 4 \"test/2_aoj/area_of_intersection_between_two_circles.test.cpp\"\
    ...
    \ += s - t;\n            std::swap(a, b);\n        }\n        return res;\n  \
    \  }\n};\n#line 6 \"test/2_aoj/area_of_intersection_between_two_circles.test.cpp\"\
    \n\nusing cir = Circle<int>;\n\nint main() {\n    std::ios::sync_with_stdio(0),\
    \ std::cin.tie(0);\n    cir a, b;\n    std::cin >> a.o >> a.r >> b.o >> b.r;\n\
    \    std::cout << std::fixed << std::setprecision(20) << circleIntersectionArea<long\
    \ double>(a, b) << \"\\n\";\n}\n\n"
  ...
  verifiedWith: []
documentation_of: test/2_aoj/area_of_intersection_between_two_circles.test.cpp
layout: document
redirect_from:
- /verify/test/2_aoj/area_of_intersection_between_two_circles.test.cpp
- /verify/test/2_aoj/area_of_intersection_between_two_circles.test.cpp.html
