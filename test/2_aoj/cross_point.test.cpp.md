...
data:
  ...
  bundledCode: "#line 1 \"test/2_aoj/cross_point.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_C\"\
    \n#line 2 \"assumption.hpp\"\n\n#include <cassert>\n#include <bits/stdc++.h>\n\
    #line 3 \"test/2_aoj/cross_point.test.cpp\"\n\n#line 2 \"Geometry/line.hpp\"\n\
    ...
    \  using type = Ln<T, eps, MulT>;\n};\n#line 5 \"test/2_aoj/cross_point.test.cpp\"\
    \n\nusing Point = Pt<int>;\nusing Line = Ln<int>;\n\nint main() {\n    std::ios::sync_with_stdio(0),\
    \ std::cin.tie(0);\n    int q;\n    std::cin >> q;\n    std::cout << std::fixed\
    \ << std::setprecision(10);\n    while (q--) {\n        Line l1, l2;\n       \
    \ std::cin >> l1[0] >> l1[1] >> l2[0] >> l2[1];\n        std::cout << lineIntersection(l1,\
    \ l2) << \"\\n\";\n    }\n}\n"
  ...
  verifiedWith: []
documentation_of: test/2_aoj/cross_point.test.cpp
layout: document
redirect_from:
- /verify/test/2_aoj/cross_point.test.cpp
- /verify/test/2_aoj/cross_point.test.cpp.html
