...
data:
  ...
  bundledCode: "#line 1 \"test/2_aoj/intersection.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_B\"\
    \n#line 2 \"assumption.hpp\"\n\n#include <bits/stdc++.h>\n#line 3 \"test/2_aoj/intersection.test.cpp\"\
    ...
    \  using type = Ln<T, eps, MulT>;\n};\n#line 5 \"test/2_aoj/intersection.test.cpp\"\
    \n\nusing Point = Pt<int>;\nusing Line = Ln<int>;\n\nint main() {\n    std::ios::sync_with_stdio(0),\
    \ std::cin.tie(0);\n    int q;\n    std::cin >> q;\n    while (q--) {\n      \
    \  Line l1, l2;\n        std::cin >> l1[0] >> l1[1] >> l2[0] >> l2[1];\n     \
    \   if (segIntersect(l1, l2)) std::cout << \"1\\n\";\n        else std::cout <<\
    \ \"0\\n\";\n    }\n}\n"
  ...
  verifiedWith: []
documentation_of: test/2_aoj/intersection.test.cpp
layout: document
redirect_from:
- /verify/test/2_aoj/intersection.test.cpp
- /verify/test/2_aoj/intersection.test.cpp.html
