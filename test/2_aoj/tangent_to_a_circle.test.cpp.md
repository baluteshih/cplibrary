...
data:
  ...
  bundledCode: "#line 1 \"test/2_aoj/tangent_to_a_circle.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_F\"\n#define\
    ...
    }\n#line 4 \"test/2_aoj/tangent_to_a_circle.test.cpp\"\n\n#line 2 \"Geometry/circle.hpp\"\
    ...
    \ += s - t;\n            std::swap(a, b);\n        }\n        return res;\n  \
    \  }\n};\n#line 6 \"test/2_aoj/tangent_to_a_circle.test.cpp\"\n\nusing cir = Circle<int>;\n\
    using Point = Pt<int>;\n\nint main() {\n    ios::sync_with_stdio(0), cin.tie(0);\n\
    \    Point p;\n    cir c;\n    cin >> p >> c.o >> c.r;\n    auto res = pointCircleTangent(p,\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_F\"\
    ...
    \ cin.tie(0);\n    Point p;\n    cir c;\n    cin >> p >> c.o >> c.r;\n    auto\
    \ res = pointCircleTangent(p, c);\n    assert(!res.empty());\n    if (res[0] >\
    \ res[1]) swap(res[0], res[1]);\n    cout << fixed << setprecision(10) << res[0]\
    \ << \"\\n\" << res[1] << \"\\n\";\n}\n\n"
  dependsOn:
  - default_code.hpp
  - Geometry/circle.hpp
  ...
  verifiedWith: []
documentation_of: test/2_aoj/tangent_to_a_circle.test.cpp
layout: document
redirect_from:
- /verify/test/2_aoj/tangent_to_a_circle.test.cpp
- /verify/test/2_aoj/tangent_to_a_circle.test.cpp.html
