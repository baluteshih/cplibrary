...
data:
  ...
  bundledCode: "#line 1 \"test/2_aoj/incircle_of_a_triangle.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_B\"\n#define\
    \ ERROR 0.000001\n#line 2 \"assumption.hpp\"\n\n#include <cassert>\n#include <bits/stdc++.h>\n\
    #line 4 \"test/2_aoj/incircle_of_a_triangle.test.cpp\"\n\n#line 2 \"Geometry/centers.hpp\"\
    ...
    \ - q, b - q));\n    return Geometry<MulT, eps>::sign(det);\n}\n#line 6 \"test/2_aoj/incircle_of_a_triangle.test.cpp\"\
    \n\nusing Point = Pt<int>;\n\nint main() {\n    std::ios::sync_with_stdio(0),\
    \ std::cin.tie(0);\n    Point a, b, c;\n    std::cin >> a >> b >> c;\n    auto\
    \ ans = incenter(a, b, c);\n    std::cout << std::fixed << std::setprecision(20);\n\
    \    std::cout << ans << \" \" << pointToLineDist(ans, LineType<decltype(ans)>::type(a,\
    \ b)) << \"\\n\";\n}\n\n"
  ...
  verifiedWith: []
documentation_of: test/2_aoj/incircle_of_a_triangle.test.cpp
layout: document
redirect_from:
- /verify/test/2_aoj/incircle_of_a_triangle.test.cpp
- /verify/test/2_aoj/incircle_of_a_triangle.test.cpp.html
