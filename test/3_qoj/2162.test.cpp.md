...
data:
  ...
  bundledCode: "#line 1 \"test/3_qoj/2162.test.cpp\"\n#define PROBLEM \"https://qoj.ac/contest/782/problem/2162\"\
    ...
    }\n#line 4 \"test/3_qoj/2162.test.cpp\"\n\n#line 2 \"Geometry/half_plane_intersection.hpp\"\
    ...
    \ l]\n#line 8 \"test/3_qoj/2162.test.cpp\"\n\nusing Point = Pt<ll>;\nusing Line\
  ...
  code: "#define PROBLEM \"https://qoj.ac/contest/782/problem/2162\"\n#define IGNORE\n\
    ...
    \        return poly.area();\n    };\n\n    auto res = half_plane_intersection<Line,\
    \ __int128>(lines);\n    double ans = area(res);\n    auto convex = convexHull(dots);\
    \ \n    for (int i = 0; i < SZ(convex); ++i)\n        lines.push_back(Line(convex[i],\
    \ convex[(i + 1) % SZ(convex)]));\n    res = half_plane_intersection<Line, __int128>(lines);\n\
    \    ans -= area(res);\n    cout << fixed << setprecision(6) << ans / 2 << \"\\\
    n\";\n}\n"
  dependsOn:
  - default_code.hpp
  ...
  verifiedWith: []
documentation_of: test/3_qoj/2162.test.cpp
layout: document
redirect_from:
- /verify/test/3_qoj/2162.test.cpp
- /verify/test/3_qoj/2162.test.cpp.html
