...
data:
  ...
  attributes:
    ...
    IGNORE_IF_GCC: ''
    links:
    - https://qoj.ac/problem/6445
  bundledCode: "#line 1 \"test/3_qoj/6445.test.cpp\"\n#define PROBLEM \"https://qoj.ac/problem/6445\"\
    ...
    }\n#line 4 \"test/3_qoj/6445.test.cpp\"\n\n#line 2 \"Geometry/convexHull3D.hpp\"\
    ...
    \ std::istream& operator>>(std::istream &is, Ln &p) { return is >> p.l[0] >> p.l[1];\
    \ }\n    friend std::ostream& operator<<(std::ostream &os, const Ln &p) { return\
  ...
  verifiedWith: []
documentation_of: test/3_qoj/6445.test.cpp
layout: document
redirect_from:
- /verify/test/3_qoj/6445.test.cpp
- /verify/test/3_qoj/6445.test.cpp.html
