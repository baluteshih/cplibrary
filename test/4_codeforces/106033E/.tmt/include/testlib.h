...
NORETURN void InStream::quit(TResult result, const char *msg) {
    ...
    if (resultName != "") {
        // https://github.com/DOMjudge/domjudge/blob/af926294f1a5c054dd170a373fe538d47012b0e8/sql/files/defaultdata/compare/compare.cc#L69
        // domjudge's default checker uses open(..., "w"), so I assume this should be more correct than "a".
