...
data:
  ...
  attributes:
    ...
    PROBLEM: https://codeforces.com/gym/106033/problem/E
    links:
    - https://codeforces.com/gym/106033/problem/E
  bundledCode: "#line 1 \"test/4_codeforces/106033E/106033E.test.cpp\"\n#define PROBLEM\
    \ \"https://codeforces.com/gym/106033/problem/E\"\n#line 2 \"assumption.hpp\"\n\
    \n#include <cassert>\n#include <bits/stdc++.h>\n#line 3 \"test/4_codeforces/106033E/106033E.test.cpp\"\
    ...
    \        return res;\n    }\n};\n#line 5 \"test/4_codeforces/106033E/106033E.test.cpp\"\
    \n\nint main() {\n    std::ios::sync_with_stdio(0), std::cin.tie(0);\n    int\
    \ n, m;\n    std::cin >> n >> m;\n    Dinic<long long> dinic(n);\n    while (m--)\
    \ {\n        int u, v, c;\n        std::cin >> u >> v >> c;\n        --u, --v;\n\
    \        dinic.add_edge(u, v, c);\n    }\n    long long res = dinic.maxflow(0,\
    \ n - 1);\n    std::cout << res << \"\\n\";\n    auto route = dinic.get_route(0,\
    \ n - 1); \n    std::cout << route.size() << \"\\n\";\n    for (auto [w, v] :\
    \ route) {\n        std::cout << w << \" \" << v.size();\n        for (int i :\
    \ v)\n            std::cout << \" \" << i + 1;\n        std::cout << \"\\n\";\n\
    \    }\n}\n"
  code: "#define PROBLEM \"https://codeforces.com/gym/106033/problem/E\"\n#include\
    \ \"assumption.hpp\"\n\n#include \"Flow/Dinic.hpp\"\n\nint main() {\n    std::ios::sync_with_stdio(0),\
    \ std::cin.tie(0);\n    int n, m;\n    std::cin >> n >> m;\n    Dinic<long long>\
    \ dinic(n);\n    while (m--) {\n        int u, v, c;\n        std::cin >> u >>\
    \ v >> c;\n        --u, --v;\n        dinic.add_edge(u, v, c);\n    }\n    long\
    \ long res = dinic.maxflow(0, n - 1);\n    std::cout << res << \"\\n\";\n    auto\
    \ route = dinic.get_route(0, n - 1); \n    std::cout << route.size() << \"\\n\"\
    ;\n    for (auto [w, v] : route) {\n        std::cout << w << \" \" << v.size();\n\
    \        for (int i : v)\n            std::cout << \" \" << i + 1;\n        std::cout\
    \ << \"\\n\";\n    }\n}\n"
  dependsOn:
  ...
  requiredBy: []
  timestamp: '2026-09-21 22:52:54+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/4_codeforces/106033E/106033E.test.cpp
layout: document
redirect_from:
- /verify/test/4_codeforces/106033E/106033E.test.cpp
- /verify/test/4_codeforces/106033E/106033E.test.cpp.html
