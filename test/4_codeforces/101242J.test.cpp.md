...
data:
  ...
  attributes:
    ...
    IGNORE_IF_GCC: ''
    links:
    - https://codeforces.com/gym/101242/problem/J
  bundledCode: "#line 1 \"test/4_codeforces/101242J.test.cpp\"\n#define PROBLEM \"\
    ...
    \ vals.end());\n}\n#line 4 \"test/4_codeforces/101242J.test.cpp\"\n\n#line 2 \"\
    ...
    \ l]\n#line 6 \"test/4_codeforces/101242J.test.cpp\"\n\nusing Point = Pt<ll>;\n\
    ...
    \      if (l <= r) add_itv(l, r);\n            else add_itv(0, r), add_itv(l,\
    \ SZ(vec) - 1), flag = 1;\n        }\n        {\n            int r = ranges::lower_bound(vec,\
    \ p - b, cmp) - vec.begin();\n            int l = ranges::lower_bound(vec, p -\
    \ a, cmp) - vec.begin();\n            if (l <= r) add_itv(l, r);\n           \
    ...
    \      }\n    }\n    else    \n        ans = num_one;\n    cout << ans << \"\\\
    n\";\n}\n"
  code: "#define PROBLEM \"https://codeforces.com/gym/101242/problem/J\"\n#define\
  ...
  verifiedWith: []
documentation_of: test/4_codeforces/101242J.test.cpp
layout: document
redirect_from:
- /verify/test/4_codeforces/101242J.test.cpp
- /verify/test/4_codeforces/101242J.test.cpp.html
