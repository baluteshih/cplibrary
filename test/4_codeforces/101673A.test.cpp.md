...
data:
  ...
  attributes:
    ...
    IGNORE_IF_GCC: ''
    links:
    - https://codeforces.com/gym/101673/problem/A
  bundledCode: "#line 1 \"test/4_codeforces/101673A.test.cpp\"\n#define PROBLEM \"\
    ...
    \ vals.end());\n}\n#line 4 \"test/4_codeforces/101673A.test.cpp\"\n\n#line 2 \"\
    ...
    \ {\n    using type = Polygon<T, eps, MulT>;\n};\n#line 6 \"test/4_codeforces/101673A.test.cpp\"\
    \n\nusing Point = Pt<int>;\nusing polygon = Polygon<int>;\n\nint main() {\n  \
    \  ios::sync_with_stdio(0), cin.tie(0);\n    int n;\n    ll area = 0;\n    cin\
    \ >> n;\n    vector<polygon> poly(n);\n    for (auto &p : poly) {\n        int\
    \ m;\n        cin >> m;\n        p.resize(m);\n        for (auto &pt : p)\n  \
    \          cin >> pt;\n        if (p.area() < 0)\n            ranges::reverse(p);\n\
    \        area += p.area();\n    }\n    cout << fixed << setprecision(8) << (double)area\
    \ / 2 << \" \" << polyUnionArea(poly) << \"\\n\";\n}\n"
  code: "#define PROBLEM \"https://codeforces.com/gym/101673/problem/A\"\n#define\
  ...
  verifiedWith: []
documentation_of: test/4_codeforces/101673A.test.cpp
layout: document
redirect_from:
- /verify/test/4_codeforces/101673A.test.cpp
- /verify/test/4_codeforces/101673A.test.cpp.html
