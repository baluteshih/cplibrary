...
std::pair<polygon, polygon> gen_poly(int n, int m, const int maxc) {
    ...
    return std::make_pair(convexHull(P), convexHull(Q));
}
...
void test() {
    ...
    std::vector<int> sz{1, 2, 2, 2, 2, 3, 3, 3, 3, 3, 3, 5, 10, 100, 1000, 10000, 100000}; 
    for (int n : sz)
        for (int m : sz) {
