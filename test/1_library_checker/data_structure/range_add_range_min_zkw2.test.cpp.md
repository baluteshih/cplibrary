...
data:
  ...
  bundledCode: "#line 1 \"test/1_library_checker/data_structure/range_add_range_min_zkw2.test.cpp\"\
    ...
    }\n#line 3 \"test/1_library_checker/data_structure/range_add_range_min_zkw2.test.cpp\"\
    ...
    \  cerr << \"\\e[0m\\n\";\n    }\n    void printall() {\n        std::cerr <<\
    \ \"\\e[1;33mInfo all:\\n\";\n        for (int i = 1; i < n + n; ++i)\n      \
    \      printnode(i);\n        cerr << \"\\e[0m\\n\";\n    }\n};\n#line 5 \"test/1_library_checker/data_structure/range_add_range_min_zkw2.test.cpp\"\
    \n\nstruct Tag {\n    ll a;\n    Tag(ll _a = 0): a(_a) {}\n    Tag operator+(const\
    ...
    \ cin.tie(0);\n    int n, q;\n    cin >> n >> q;\n    vector<Value> arr(n);\n\
    \    for (auto &v : arr)\n        cin >> v;\n    ZkwSegmentTree<Value, Tag, false>\
    \ seg(arr);\n    while (q--) {\n        int type, l, r;\n        cin >> type >>\
    \ l >> r;\n        if (type == 0) {\n            int x;\n            cin >> x;\n\
