...
data:
  ...
  bundledCode: "#line 1 \"test/1_library_checker/data_structure/persistent_queue_stackpool.test.cpp\"\
    ...
    \n\n#line 2 \"DataStructure/StackPoolAllocator.hpp\"\n\n#ifndef POOL_SIZE\n  \
    ...
    \ {\n            return v.size() <= k;\n        }), this);\n    }\n};\n#line 6\
    \ \"test/1_library_checker/data_structure/persistent_queue_stackpool.test.cpp\"\
    \n\nusing treap = Treap<int, size_v, void, false, StackPoolAllocator, true>;\n\
  ...
  code: "#define PROBLEM \"http://judge.yosupo.jp/problem/persistent_queue\"\n#include\
    \ \"assumption.hpp\"\n\n#include \"DataStructure/StackPoolAllocator.hpp\"\n#include\
    \ \"DataStructure/Treap.hpp\"\n\nusing treap = Treap<int, size_v, void, false,\
    \ StackPoolAllocator, true>;\n\nint main() {\n    std::ios::sync_with_stdio(0),\
    \ std::cin.tie(0);\n    int q;\n    std::cin >> q;\n    std::vector<treap> roots(1,\
    \ treap());\n    while (q--) {\n        int op, t;\n        std::cin >> op >>\
    \ t;\n        roots.push_back(roots[++t]);\n        if (op == 0) {\n         \
    \   int x;\n            std::cin >> x;\n            roots.back().push_back(treap(x,\
    \ 1));\n        }\n        else {\n            auto lft = roots.back().split_size(1);\n\
    \            std::cout << lft.get_key() << \"\\n\";\n        }\n    }\n}\n"
  dependsOn:
  - assumption.hpp
  - DataStructure/StackPoolAllocator.hpp
  - DataStructure/Treap.hpp
  ...
  verifiedWith: []
documentation_of: test/1_library_checker/data_structure/persistent_queue_stackpool.test.cpp
layout: document
redirect_from:
- /verify/test/1_library_checker/data_structure/persistent_queue_stackpool.test.cpp
- /verify/test/1_library_checker/data_structure/persistent_queue_stackpool.test.cpp.html
