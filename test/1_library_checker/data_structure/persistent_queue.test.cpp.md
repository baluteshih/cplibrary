...
data:
  ...
  bundledCode: "#line 1 \"test/1_library_checker/data_structure/persistent_queue.test.cpp\"\
  ...
  code: "#define PROBLEM \"http://judge.yosupo.jp/problem/persistent_queue\"\n#include\
    ...
    \ Treap<int, size_v, void, false, DefaultAllocator, true>;\n\nint main() {\n \
    \   std::ios::sync_with_stdio(0), std::cin.tie(0);\n    int q;\n    std::cin >>\
    \ q;\n    std::vector<treap> roots(1, treap());\n    while (q--) {\n        int\
    \ op, t;\n        std::cin >> op >> t;\n        roots.push_back(roots[++t]);\n\
    \        if (op == 0) {\n            int x;\n            std::cin >> x;\n    \
  ...
  verifiedWith: []
documentation_of: test/1_library_checker/data_structure/persistent_queue.test.cpp
layout: document
redirect_from:
- /verify/test/1_library_checker/data_structure/persistent_queue.test.cpp
- /verify/test/1_library_checker/data_structure/persistent_queue.test.cpp.html
