...
data:
  ...
  bundledCode: "#line 1 \"test/1_library_checker/biginteger/multiplication.test.cpp\"\
    \n#define PROBLEM \"https://judge.yosupo.jp/problem/multiplication_of_big_integers\"\
    \n#line 2 \"assumption.hpp\"\n\n#include <cassert>\n#include <bits/stdc++.h>\n\
    #line 3 \"test/1_library_checker/biginteger/multiplication.test.cpp\"\n\n#line\
    ...
    \ \n    long long to_ll() {\n        long long x = 0;\n        for (int i = dat.size()\
    \ - 1; i >= 0; --i)\n            x = MOD * x + dat[i];\n        return sgn * x;\n\
    \    }\n};\n#line 5 \"test/1_library_checker/biginteger/multiplication.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/1_library_checker/biginteger/multiplication.test.cpp
layout: document
redirect_from:
- /verify/test/1_library_checker/biginteger/multiplication.test.cpp
- /verify/test/1_library_checker/biginteger/multiplication.test.cpp.html
