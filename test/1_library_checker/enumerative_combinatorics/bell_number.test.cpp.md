...
data:
  ...
  bundledCode: "#line 1 \"test/1_library_checker/enumerative_combinatorics/bell_number.test.cpp\"\
    ...
    }\n#line 3 \"test/1_library_checker/enumerative_combinatorics/bell_number.test.cpp\"\
    ...
    \  return std::vector<T>(res.begin(), res.end());\n}\n#line 6 \"test/1_library_checker/enumerative_combinatorics/bell_number.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/1_library_checker/enumerative_combinatorics/bell_number.test.cpp
- /verify/test/1_library_checker/enumerative_combinatorics/bell_number.test.cpp.html
