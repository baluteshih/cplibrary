...
data:
  ...
  bundledCode: "#line 1 \"test/1_library_checker/enumerative_combinatorics/stirling_number_of_the_first_kind_fixed_k.test.cpp\"\
    \n#define PROBLEM \"https://judge.yosupo.jp/problem/stirling_number_of_the_first_kind_fixed_k\"\
    \n#line 2 \"assumption.hpp\"\n\n#include <cassert>\n#include <bits/stdc++.h>\n\
    #line 3 \"test/1_library_checker/enumerative_combinatorics/stirling_number_of_the_first_kind_fixed_k.test.cpp\"\
    ...
    #line 2 \"Numbers/stirling_first_kind_row.hpp\"\n\n#line 2 \"Numeric/Combination.hpp\"\
    ...
    \ additionally\n    Poly Sqrt() const;\n    bool has_sqrt() const;\n    Poly&\
    \ shift(T c);\n};\nusing Poly_t = Poly<modint998244353>;\n#line 5 \"Numbers/stirling_first_kind_row.hpp\"\
    \n\ntemplate <typename T>\nstd::vector<T> stirling_first_kind_row(int k, int n)\
    \ {\n    if (n < k) return {};\n    Combination<T> comb(n + 1);\n    auto inv\
    \ = CombFunc::linear_inverse<T>(n + 1);\n    Poly<T> res(n + 1);\n    for (int\
    \ i = 1; i <= n; ++i) res[i] = inv[i];\n    res = res.Pow(k) * comb.ifac[k];\n\
    \    for (int i = k; i <= n; ++i) {\n        res[i] *= comb.fac[i];\n        if\
    \ ((i ^ k) & 1) res[i] *= T(-1);\n    }\n    return res;\n}\n#line 6 \"test/1_library_checker/enumerative_combinatorics/stirling_number_of_the_first_kind_fixed_k.test.cpp\"\
    \n\nusing mint = modint998244353;\n\nint main() {\n    std::ios::sync_with_stdio(0),\
    \ std::cin.tie(0);\n    int n, k;\n    std::cin >> n >> k;\n    auto res = stirling_first_kind_row<mint>(k,\
    \ n);\n    for (int i = k; i <= n; ++i)\n        std::cout << res[i] << \" \\\
    n\"[i == n];\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/stirling_number_of_the_first_kind_fixed_k\"\
    ...
    \    std::cin >> n >> k;\n    auto res = stirling_first_kind_row<mint>(k, n);\n\
    \    for (int i = k; i <= n; ++i)\n        std::cout << res[i] << \" \\n\"[i ==\
    \ n];\n}\n"
  dependsOn:
  - assumption.hpp
...
layout: document
redirect_from:
- /verify/test/1_library_checker/enumerative_combinatorics/stirling_number_of_the_first_kind_fixed_k.test.cpp
- /verify/test/1_library_checker/enumerative_combinatorics/stirling_number_of_the_first_kind_fixed_k.test.cpp.html
