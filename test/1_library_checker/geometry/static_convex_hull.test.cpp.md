...
data:
  ...
  bundledCode: "#line 1 \"test/1_library_checker/geometry/static_convex_hull.test.cpp\"\
    ...
    }\n#line 3 \"test/1_library_checker/geometry/static_convex_hull.test.cpp\"\n\n\
    ...
    \ l]\n#line 5 \"test/1_library_checker/geometry/static_convex_hull.test.cpp\"\n\
    \nusing Point = Pt<ll>;\n\nvoid solve() {\n    int n;\n    cin >> n;\n    vector<Point>\
  ...
  verifiedWith: []
documentation_of: test/1_library_checker/geometry/static_convex_hull.test.cpp
layout: document
redirect_from:
- /verify/test/1_library_checker/geometry/static_convex_hull.test.cpp
- /verify/test/1_library_checker/geometry/static_convex_hull.test.cpp.html
