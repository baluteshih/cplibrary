...
data:
  ...
  bundledCode: "#line 1 \"test/1_library_checker/polynomial/sqrt_of_formal_power_series.test.cpp\"\
    ...
    }\n#line 3 \"test/1_library_checker/polynomial/sqrt_of_formal_power_series.test.cpp\"\
    \n\n#line 2 \"Polynomial/Sqrt.hpp\"\n\n#line 2 \"Polynomial/Polynomial.hpp\"\n\
    ...
    \ Poly &rhs) {\n        for (int i = 0; i < n(); ++i)\n            (*this)[i]\
    \ *= rhs[i];\n        return *this;\n    }\n    Poly& strip() {\n        while\
    \ (!this->empty() && this->back() == 0)\n            this->pop_back();\n     \
    \   return *this;\n    }\n    Poly operator+(const Poly &rhs) const { // n() ==\
    \ rhs.n()\n        Poly res(*this);\n        for (int i = 0; i < n(); ++i)\n \
    \           res[i] += rhs[i];\n        return res;\n    }\n    Poly operator-(const\
    \ Poly &rhs) const { // n() == rhs.n()\n        Poly res(*this);\n        for\
    \ (int i = 0; i < n(); ++i)\n            res[i] -= rhs[i];\n        return res;\n\
    ...
    \ tmp = g0 * f0 + d * g1 * f1;\n            g1 = g0 * f1 + g1 * f0;\n        \
    \    g0 = tmp;\n        }\n        tmp = f0 * f0 + d * f1 * f1;\n        f1 =\
    \ f0 * f1 * 2;\n        f0 = tmp;\n    }\n    return g0;\n}\n#line 5 \"Polynomial/Sqrt.hpp\"\
    \n\ntemplate<class T>\nPoly<T> Poly<T>::Sqrt() const { // has_sqrt() is true,\
    \ 5e5/491ms\n    if (n() == 1) { \n        bool succ;\n        return { quadratic_residue((*this)[0],\
    \ succ) };\n    }\n    if ((*this)[0] == 0) {\n        int cnt = 0;\n        while\
    ...
    \ X.Inv()).isz(n())) * (T::mod() / 2 + 1);\n}\ntemplate<class T>\nbool Poly<T>::has_sqrt()\
    \ const {\n    int cnt = 0;\n    while (cnt < n() && (*this)[cnt] == 0) ++cnt;\n\
    \    if (cnt == n()) return true;\n    if (cnt % 2 != 0) return false;\n    int\
    \ jc = jacobi((*this)[cnt].val(), T::mod());\n    return jc == 1;\n}\n#line 5\
  ...
  verifiedWith: []
documentation_of: test/1_library_checker/polynomial/sqrt_of_formal_power_series.test.cpp
layout: document
redirect_from:
- /verify/test/1_library_checker/polynomial/sqrt_of_formal_power_series.test.cpp
- /verify/test/1_library_checker/polynomial/sqrt_of_formal_power_series.test.cpp.html
