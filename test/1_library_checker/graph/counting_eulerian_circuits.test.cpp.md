...
data:
  ...
  bundledCode: "#line 1 \"test/1_library_checker/graph/counting_eulerian_circuits.test.cpp\"\
    \n#define PROBLEM \"https://judge.yosupo.jp/problem/counting_eulerian_circuits\"\
    \n#line 2 \"assumption.hpp\"\n\n#include <cassert>\n#include <bits/stdc++.h>\n\
    #line 3 \"test/1_library_checker/graph/counting_eulerian_circuits.test.cpp\"\n\
    ...
    #line 2 \"Graph/count_eulerian_circuits.hpp\"\n\n#line 2 \"Graph/eulerian_trail.hpp\"\
    ...
    \ += T(1);\n            mat[e.to][e.from] -= T(1);\n        }\n    }\n    return\
    \ mat.minor(root, root).det();\n}\n#line 5 \"Graph/count_eulerian_circuits.hpp\"\
    \n\ntemplate<typename T, typename graph>\nT count_eulerian_circuits(const graph\
    ...
    \    std::vector<T> fac(mx, 1);\n    for (int i = 2; i < mx; ++i) fac[i] = fac[i\
    \ - 1] * i;\n    T ans = 1;\n    for (int i = 0; i < G.n(); ++i)\n        if (in_degree[i]\
    \ > 0)\n            ans *= fac[in_degree[i] - 1];\n    ans *= count_spanning_tree<T>(G.induced(vertices));\n\
    \    return ans;\n}\n#line 6 \"test/1_library_checker/graph/counting_eulerian_circuits.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/1_library_checker/graph/counting_eulerian_circuits.test.cpp
layout: document
redirect_from:
- /verify/test/1_library_checker/graph/counting_eulerian_circuits.test.cpp
- /verify/test/1_library_checker/graph/counting_eulerian_circuits.test.cpp.html
