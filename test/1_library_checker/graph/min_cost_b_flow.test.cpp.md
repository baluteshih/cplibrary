...
data:
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/min_cost_b_flow\"\n#include\
    ...
    \ \"Misc/i128.hpp\"\n\nint main() {\n    std::ios::sync_with_stdio(0), std::cin.tie(0);\n\
    \    int n, m;\n    std::cin >> n >> m;\n    bounded_cost_circulation<long long,\
    \ __int128> flow(n);\n    for (int i = 0; i < n; ++i) {\n        long long demand;\n\
    \        std::cin >> demand;\n        flow.add_demand(i, demand);\n    }\n   \
    \ for (int i = 0; i < m; ++i) {\n        long long s, t, l, u, c;\n        std::cin\
    \ >> s >> t >> l >> u >> c;\n        flow.add_edge(s, t, l, u, c);\n    }\n\n\
...
layout: document
redirect_from:
- /verify/test/1_library_checker/graph/min_cost_b_flow.test.cpp
- /verify/test/1_library_checker/graph/min_cost_b_flow.test.cpp.html
