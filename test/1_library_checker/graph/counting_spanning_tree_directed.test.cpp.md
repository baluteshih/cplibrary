...
data:
  ...
  bundledCode: "#line 1 \"test/1_library_checker/graph/counting_spanning_tree_directed.test.cpp\"\
    \n#define PROBLEM \"https://judge.yosupo.jp/problem/counting_spanning_tree_directed\"\
    \n#line 2 \"assumption.hpp\"\n\n#include <cassert>\n#include <bits/stdc++.h>\n\
    #line 3 \"test/1_library_checker/graph/counting_spanning_tree_directed.test.cpp\"\
    ...
    \ 2 \"Algebra/ValidOperation.hpp\"\n\ntemplate <typename A, typename B>\nconcept\
    \ Addable = !std::is_void_v<A> && !std::is_void_v<B> && requires(A a, B b) { a\
    \ + b; };\n\ntemplate <typename A, typename B>\nconcept Subtractable = !std::is_void_v<A>\
    \ && !std::is_void_v<B> && requires(A a, B b) { a - b; };\n\ntemplate <typename\
    \ A, typename B>\nconcept Multiplicable = !std::is_void_v<A> && !std::is_void_v<B>\
    ...
    \ += T(1);\n            mat[e.to][e.from] -= T(1);\n        }\n    }\n    return\
    \ mat.minor(root, root).det();\n}\n#line 7 \"test/1_library_checker/graph/counting_spanning_tree_directed.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/1_library_checker/graph/counting_spanning_tree_directed.test.cpp
layout: document
redirect_from:
- /verify/test/1_library_checker/graph/counting_spanning_tree_directed.test.cpp
- /verify/test/1_library_checker/graph/counting_spanning_tree_directed.test.cpp.html
