...
data:
  ...
  bundledCode: "#line 1 \"test/8_luogu/P5055.test.cpp\"\n#define PROBLEM \"https://www.luogu.com.cn/problem/P5055\"\
    ...
    \ Value &v) {\n            return v.size() < k;\n        }), this);\n    }\n};\n\
    #line 6 \"test/8_luogu/P5055.test.cpp\"\n\n#define POOL_SIZE 17000000\n#line 2\
    ...
    \n\nstruct Value {\n    ll sum;\n    int sz;\n    Value(ll x = 0, int sz_ = 0):\
    \ sum(x), sz(sz_) {}\n    Value operator+(const Value &rhs) const {\n        return\
    \ Value(sum + rhs.sum, sz + rhs.sz);\n    }\n    int size() const {\n        return\
    \ sz; \n    }\n    friend ostream& operator<<(ostream& os, const Value &v) {\n\
    \        os << v.sum << \" \" << v.sz;\n        return os;\n    }\n};\n\nusing\
    \ treap = Treap<void, Value, void, true, PoolAllocator, true>;\n\nint main() {\n\
  ...
  code: "#define PROBLEM \"https://www.luogu.com.cn/problem/P5055\"\n#define IGNORE\n\
    ...
    \ \n    }\n    friend ostream& operator<<(ostream& os, const Value &v) {\n   \
    \     os << v.sum << \" \" << v.sz;\n        return os;\n    }\n};\n\nusing treap\
    \ = Treap<void, Value, void, true, PoolAllocator, true>;\n\nint main() {\n   \
    \ ios::sync_with_stdio(0), cin.tie(0);\n    int n;\n    cin >> n;\n    vector<treap>\
    \ tree(n + 1);\n    ll lastans = 0;\n    for (int i = 1; i <= n; ++i) {\n    \
    \    int v, op;\n        cin >> v >> op;\n        tree[i] = tree[v];\n       \
    \ if (op == 1) {\n            ll p, x;\n            cin >> p >> x;\n         \
  ...
  requiredBy: []
  timestamp: '2026-05-05 22:17:50+08:00'
